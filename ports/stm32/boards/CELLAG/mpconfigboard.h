#define MICROPY_HW_BOARD_NAME       "CellAgv0.7"
...
//#define MICROPY_HW_UART3_TX     (pin_B10)//disable
...
#define MICROPY_HW_I2C1_SCL (pin_B10)//b10
#define MICROPY_HW_I2C1_SDA (pin_B11)//b11
#define MICROPY_HW_I2C2_NAME "Y"
#define MICROPY_HW_I2C2_SCL (pin_B8)//b8
#define MICROPY_HW_I2C2_SDA (pin_B9)//b9
